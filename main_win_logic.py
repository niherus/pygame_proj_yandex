...
class ShooterWin:
    ...
    def __init__(self):
        width, height = 1600, 900  # 1920, 1080  # 16 : 9
        pygame.init()
        ...
        self.boss = Boss(self.screen, self.level, self.textures['turtle'], (300, 300), self.player)
        self.boss.enemies.append(self.player)
